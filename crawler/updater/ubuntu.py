...
def ubuntu_update_check(release, last_checksum):
    ...
    print("ubuntu_update_check/checksum_url:" + checksum_url)
    ...
    print("ubuntu_update_check/imagename:" + imagename)

    current_checksum = web_get_checksum(checksum_url, imagename)

    print("ubuntu_update_check/current_checksum:" + current_checksum)
    ...
    if current_checksum != last_checksum:
        ...
        print("ubuntu_update_check/image_url:" + image_url)

        image_filedate = url_get_last_modified(image_url)

        print("ubuntu_update_check/image_filedate:" + image_filedate)
